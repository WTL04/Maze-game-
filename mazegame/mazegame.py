...
def game_screen():
	...
	while running:
		...
		path0 = pygame.draw.rect(screen, 'red', pygame.Rect(350, 720, 100, 60) )
		...
		path18 = pygame.draw.rect(screen, 'blue', pygame.Rect(400, 30, 30, 30) )
